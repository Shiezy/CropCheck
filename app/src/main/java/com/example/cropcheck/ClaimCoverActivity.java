...
public class ClaimCoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_claim_cover);
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                farm_id = extras.getInt("farm_id");
                policy_id = extras.getInt("policy_id");
                cover_id = extras.getInt("cover_id");
            ...
            farm_id = (Integer) savedInstanceState.getSerializable("site_id");
        }
